...
import dinossolatte.config.audit.AuditEventConverter;
import dinossolatte.domain.PersistentAuditEvent;
...
import static dinossolatte.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
