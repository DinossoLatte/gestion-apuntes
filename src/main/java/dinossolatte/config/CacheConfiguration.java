...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(dinossolatte.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(dinossolatte.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
            cm.createCache(dinossolatte.domain.User.class.getName(), jcacheConfiguration);
            cm.createCache(dinossolatte.domain.Authority.class.getName(), jcacheConfiguration);
